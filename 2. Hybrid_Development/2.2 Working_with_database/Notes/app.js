...
var GET_NOTES_MESSAGE_PORT = "GET_NOTES_MESSAGE_PORT";
...
function onReceived(data) {
	...
	/*Добавление полученной заметки в список*/
	addNote(data[0].value, data[1].value);
}

function registerMessagePort(){
	/*Создание объекта для регистрации сообщения*/
	localMsgReceiver = tizen.messageport.requestLocalMessagePort(GET_NOTES_MESSAGE_PORT);
